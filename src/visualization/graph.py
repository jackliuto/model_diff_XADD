...
class RDDL2GraphFile:

    def __init__(self, domain_name:str='test', instance_number: int=0, domain_path: str='',
                 instance_path: str='',
                 directed: bool=True,
                 strict_grouping: bool=False):
        
        # Read the domain and instance files
        self._domain, self._instance = domain_name, str(instance_number)
    ...
    def get_node_name(self, gvar: str, primed: bool=False) -> str:
        ...
        objects = RDDL2GraphFile.get_objects(gvar if not primed else gvar[:-1], pvar)
