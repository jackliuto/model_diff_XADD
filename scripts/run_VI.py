...
# fpath_1_value = '../visualization/VI/value_maps/vplot501010.png'
...
# fpath_1_xadd_reward = '../visualization/VI/xadd_graphs/xadd_reward_501010.png'
...
# fpath_1_xadd_value = '../visualization/VI/xadd_graphs/xadd_value_501010.png'
...
vid_1 = ModelDiff.do_VI(model_1, context_1, 2)
vid_2 = ModelDiff.do_VI(model_2, context_2, 2)
vid_diff = ModelDiff.do_VI(model_diff, context_diff, 2)
